...
const Footer = () => {
  ...
  return (
    // <footer className={`bg-gray-900 ${footer ? "pl-[300px]" : ""}  py-10 px-4 border-t border-slate-300 mt-[120px]  `}>
    //   {/* Top Section */}
    ...
    //   </div>
    // </footer>
    <footer className="mt-[60px] footer footer-center bg-base-200 text-base-content rounded p-10">
  ...
  <aside>
    <p>Copyright © {new Date().getFullYear()} - All right reserved by old book buy sells website creation team</p>
  </aside>
</footer>
  )
}
